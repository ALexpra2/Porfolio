import projectbreak2 from './assets/projectbreak2.png';
import dashboard from './assets/dashboard.png';
import andandoVoy from './assets/andandovoy.png'; // Asume que agregas una imagen para este proyecto
...
const projects = [
  {
    ...
    image: andandoVoy,
    description:
      'Frontend en React y backend en Express. Visualización de rutas con Leaflet, acceso de administrador mediante JWT, blog, marketplace y gestión de guías. Autenticación con Firebase y rutas por usuario.',
  ...
  },
  {
    ...
    image: dashboard,
    description:
      'Aplicación web con generador de contraseñas, reloj en tiempo real, almacenamiento de URLs favoritas y consulta del clima con API externa.',
